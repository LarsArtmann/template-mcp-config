 ...
 */
export async function validateMCPConfig(configPath = DEFAULT_CONFIG_PATH) {
  const result = {
    valid: true,
    errors: [],
    warnings: [],
...
// CLI execution
if (process.argv[1] && process.argv[1].includes('validate-config.js')) {
